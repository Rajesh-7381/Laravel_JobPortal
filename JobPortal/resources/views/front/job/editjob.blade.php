    ...
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <form action="" id="editjobform" name="editjobform" method="post">
                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" placeholder="Location" id="location" name="location" value="{{$job->company_location}}" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="Website" id="website" name="website" value="{{$job->company_website}}" class="form-control">
                                <p></p>
                            </div>
                        </div> 
...
<script>
    $("#editjobform").submit(function(e){
        e.preventDefault();
        // console.log($("#editjobform").serialize());
        // return false;
        ...
        $.ajax({
            ...
            data: $("#editjobform").serialize(), // Serialize the form data
            dataType: 'json',

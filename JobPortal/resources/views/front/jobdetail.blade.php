            ...
            <div class="col">
                <nav aria-label="breadcrumb" class=" rounded-3 p-3">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="jobs.html"><i class="fa fa-arrow-left"
                ...
                <div class="card shadow border-0">
                    <div class="job_sumary">
                        ...
                        <div class="job_content pt-3">
                            <ul>
                                <li>Published on: <span>{{\Carbon\Carbon::parse($job->created_at)->format('d
                                        M,Y')}}</span></li>
    ...
    function applyJob(id) {
        ...
        if (confirm("Are you sure you want to apply for this job?")) {
            $.ajax({
                ...
                data: { id: id }, // Serialize the form data
                dataType: 'json',
                success: function (response) {
                    window.location.href="{{url()->current()}}"; // Corrected this line
                }
            });
        }
    }

            ...
            <div class="col-md-4 col-lg-3 sidebar mb-4">
                <form action=""  name="searchform" id="searchform">
                    <div class="card border-0 shadow p-4">
                        <div class="mb-4">
                            <h2>Keywords</h2>
                            <input value="{{Request::get('keyword')}}" type="text" placeholder="Keywords" id="keyword" name="keyword" class="form-control">
                        </div>

                        <div class="mb-4">
                            <h2>Location</h2>
                            <input value="{{Request::get('location')}}" type="text" placeholder="Location" id="location" name="location" class="form-control">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="category" id="category" class="form-control">
                                ...
                                <option value="{{(Request::get('category') == $category->id) ? 'selected': ''}}" value="{{$category->id}}">{{$category->name}}</option>
                                @endforeach
                                @endif
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" name="job_type" type="checkbox" value="{{$jobtype->id}}" {{(in_array($jobtype->id, $jobtypesarray)) ? 'checked' : ''}} id="job-type-{{$jobtype->id}}">
                        ...
                        <button type="submit" class=" btn button-primary bg-success text-warning">Search</button>
                        <a href="{{route('jobs')}}" class=" mt-3 btn button-secondary bg-secondary text-white">Reset</a>
                    </div>
                </form>
            </div>
                                ...
                                <div class="card border-0 p-3 shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="bg-light p-3 border">
                                            ...
                                            <p class="mb-0">
                                                <span class="fw-bolder"><i class="fa fa-clock-o">{{$job->jobType->name}}</i></span>
